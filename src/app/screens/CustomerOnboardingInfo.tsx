...
export function CustomerOnboardingInfo() {
  ...
  return (
    <div className="min-h-screen bg-[#050A15] text-white flex flex-col">
          ...
          <Card className="bg-slate-900/40 border-white/10 backdrop-blur-xl shadow-2xl overflow-hidden">
            ...
            <CardFooter className="p-6 sm:p-8 pt-0 flex justify-between gap-4">
              ...
              {step < 2 ? (
                <Button 
                  onClick={() => setStep(step + 1)}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 gap-2 h-11"
                >
                  Continue <ArrowRight className="w-4 h-4" />
                </Button>
              ) : (
                <Button 
                  onClick={() => navigate("/onboarding/video")}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 gap-2 h-11 shadow-lg shadow-blue-600/20"
                >
