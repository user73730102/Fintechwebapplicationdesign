...
import { Download, FileCheck, ShieldAlert, TrendingUp, AlertTriangle, ChevronDown, MessageSquare } from "lucide-react";
...
export function CustomerResults() {
  ...
  return <div className="min-h-screen bg-slate-50 p-6 md:p-12">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="p-8">
                <div className="space-y-8">
                  <div>
                    ...
                    <input type="range" min="50000" max="1000000" step="10000" value={loanAmount} onChange={e => setLoanAmount(Number(e.target.value))} className="w-full h-2 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-blue-600" />
                  ...
                  <div className="h-64 w-full mt-8">
                    <ResponsiveContainer width="100%" height="100%">
                      <AreaChart data={MOCK_DATA.map(d => ({
                      ...d,
                      payment: loanAmount / d.term * (1 + d.rate / 100)
                    }))}>
                        <defs>
                        ...
                        <XAxis dataKey="term" tickFormatter={v => `${v}mo`} axisLine={false} tickLine={false} tick={{
                        fill: '#64748b',
                        fontSize: 12
                      }} />
                      ...
                      })}`, "Monthly Payment"]} labelFormatter={label => `${label} Months`} contentStyle={{
                        borderRadius: '8px',
                        border: 'none',
            ...
            <Card>
              <CardHeader className="cursor-pointer hover:bg-slate-50 transition-colors" onClick={() => setShowTranscript(!showTranscript)}>
              ...
              {showTranscript && <CardContent className="border-t border-slate-100 pt-6 bg-slate-50/50">
