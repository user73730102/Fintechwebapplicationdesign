...
export function AgentSession() {
  ...
  const [activeTab, setActiveTab] = useState<"data" | "reasoning" | "risk">("data");
        ...
        <Card className="flex-1 flex flex-col min-h-0 border-slate-200">
          <CardHeader className="py-4 border-b border-slate-100 bg-white shrink-0">
            <CardTitle className="text-base flex items-center justify-between">
              ...
              <Badge variant="outline" className="bg-slate-50 text-slate-500">ID: #{id}</Badge>
            </CardTitle>
          </CardHeader>
          <CardContent className="flex-1 overflow-y-auto p-6 space-y-6 bg-slate-50/50">
            <div className="flex flex-col gap-1.5 max-w-[85%]">
              <span className="text-xs font-bold text-blue-600 uppercase tracking-wider ml-1">AI Agent</span>
              <div className="bg-white border border-slate-200 p-4 rounded-2xl rounded-tl-none text-sm text-slate-700 shadow-sm leading-relaxed">
                Hello John. Could you verify your current address?
              </div>
            </div>
            
            <div className="flex flex-col gap-1.5 items-end ml-auto max-w-[85%]">
              <span className="text-xs font-bold text-slate-500 uppercase tracking-wider mr-1">Customer (John)</span>
            ...
            <div className="flex flex-col gap-1.5 max-w-[85%]">
              <span className="text-xs font-bold text-blue-600 uppercase tracking-wider ml-1">AI Agent</span>
              <div className="bg-white border border-slate-200 p-4 rounded-2xl rounded-tl-none text-sm text-slate-700 shadow-sm leading-relaxed">
                Got it. I see you're applying for a $50,000 personal loan. What is the primary purpose of this loan?
              </div>
            </div>
          ...
          <div className="p-4 border-t border-slate-100 bg-white shrink-0">
            <label className="text-xs font-bold text-slate-500 block mb-2 uppercase tracking-wider">Direct AI Intervention</label>
            <div className="flex gap-3">
              <input 
                type="text" 
                placeholder="E.g., Prompt the AI to ask about employment history..."
                className="flex-1 text-sm border border-slate-200 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:border-transparent transition-shadow"
                value={agentInput}
      ...
      <Card className="flex-[0.4] flex flex-col h-[calc(100vh-8rem)] border-slate-200">
        ...
        <div className="flex p-2 bg-slate-50/80 border-b border-slate-100 gap-1 shrink-0">
          <button 
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "data" ? "bg-white text-slate-900 shadow-sm border border-slate-200/50" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100"
            }`}
          >
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "reasoning" ? "bg-white text-indigo-700 shadow-sm border border-slate-200/50" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100"
            }`}
          >
          ...
          <button 
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "risk" ? "bg-white text-amber-700 shadow-sm border border-slate-200/50" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100"
            }`}
          >
            <ShieldAlert className="w-4 h-4" /> Risk
            <span className="w-4 h-4 rounded-full bg-amber-500 text-white text-[10px] flex items-center justify-center ml-1">1</span>
          </button>
        </div>
        ...
        <CardContent className="flex-1 overflow-y-auto p-6 bg-slate-50/30">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-slate-900 flex items-center gap-2">
                  <Database className="w-5 h-5 text-blue-500" /> Customer Profile
                </h3>
              ...
              <div className="grid grid-cols-1 gap-4 text-sm">
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col gap-1">
                  ...
                  <span className="font-medium text-slate-900 text-base">John Doe</span>
                </div>
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col gap-1">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-wider flex justify-between">
                    Identity Check
                    <span className="text-emerald-600 flex items-center gap-1"><FileText className="w-3 h-3" /> Confirmed</span>
                  </span>
                  <span className="font-medium text-slate-900 text-base">Drivers License verified</span>
                </div>
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col gap-1">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Address</span>
                  <span className="font-medium text-slate-900 text-base">123 Main St, Springfield</span>
                </div>
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col gap-1">
                  <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Est. Income</span>
                  <span className="font-medium text-slate-900 text-base">$120,000/yr</span>
                </div>
                <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex flex-col gap-1 border-blue-200 ring-1 ring-blue-500/10">
                  ...
                  <span className="font-medium text-slate-900 text-base">Home Renovation</span>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === "reasoning" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <h3 className="font-bold text-slate-900 flex items-center gap-2 mb-4">
                <Cpu className="w-5 h-5 text-indigo-500" /> Live AI Engine
              </h3>
              ...
              <div className="relative pl-6 space-y-8 before:absolute before:inset-0 before:left-[11px] before:w-px before:bg-slate-200">
                <div className="relative">
                  ...
                  <h4 className="text-xs font-bold text-indigo-600 uppercase tracking-wider mb-1">Intent Classification</h4>
                  <p className="text-sm text-slate-700 bg-white p-3 rounded-lg border border-slate-100 shadow-sm">
                    Identified goal: Personal Loan ($50,000) for "Home Renovation". Next required data point: Income Verification.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xs font-bold text-emerald-600 uppercase tracking-wider mb-1">Sentiment Analysis</h4>
                  <p className="text-sm text-slate-700 bg-white p-3 rounded-lg border border-slate-100 shadow-sm">
                    Customer sentiment is positive and cooperative. Voice stress levels are normal.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <h4 className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-1">Context Aggregation</h4>
                  <p className="text-sm text-slate-700 bg-white p-3 rounded-lg border border-slate-100 shadow-sm">
                    Querying internal CRM. Customer has a checking account opened in 2018 with average balance of $12,500.
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === "risk" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <h3 className="font-bold text-slate-900 flex items-center gap-2 mb-4">
                <ShieldAlert className="w-5 h-5 text-amber-500" /> Compliance Checks
              </h3>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-amber-900 mb-1">Device Geolocation Mismatch</h4>
                    <p className="text-sm text-amber-700 leading-relaxed mb-4">
                      The user's IP address indicates they are 50 miles away from their stated home address in Springfield.
                    </p>
                    <div className="flex gap-3">
                      <Button variant="outline" className="flex-1 bg-white text-sm border-amber-200 text-amber-900 hover:bg-amber-100">Dismiss Flag</Button>
                      <Button variant="secondary" className="flex-1 bg-amber-600 hover:bg-amber-700 text-white text-sm border-transparent">Require Proof</Button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-slate-900 mb-1">KYC Watchlist Scan</h4>
                    <p className="text-sm text-slate-500 leading-relaxed flex items-center gap-2">
                      <div className="w-2 h-2 rounded-full bg-emerald-500" /> Clear. No matches found on OFAC or PEP lists.
                    </p>
                  </div>
                </div>
              </div>
