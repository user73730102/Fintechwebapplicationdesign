    ...
    <div className="flex h-full bg-slate-100 p-6 gap-6">
      ...
      <div className="flex-[0.6] flex flex-col gap-6 h-[calc(100vh-8rem)] min-w-0">
        ...
        <Card className="shrink-0 overflow-hidden bg-slate-900 border-slate-800 relative aspect-video flex items-center justify-center shadow-lg">
          <ImageWithFallback
            src="https://www.shutterstock.com/shutterstock/videos/3783125411/thumb/11.jpg?ip=x480"
            alt="User Webcam"
      ...
      <Card className="flex-[0.4] flex flex-col h-[calc(100vh-8rem)] border-slate-200">
        ...
        <div className="flex p-2 bg-slate-50/80 border-b border-slate-100 gap-1 shrink-0">
          <button
            ...
            className={`flex-1 border border-primary flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${activeTab === "data" ? "bg-white text-slate-900 shadow-sm border border-slate-200/50" : "text-slate-500 hover:text-slate-700 hover:bg-slate-100"} text-[#3369bd]`}
          >
            <Database className="w-4 h-4" /> Extracted
          </button>
          <button
            onClick={() => setActiveTab("reasoning")}
            className={`flex-1 border border-primary flex items-center justify-center gap-2 py-2.5 px-3 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "reasoning"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <Button
                        variant="outline"
                        className="flex-1 bg-white text-sm border-amber-200 text-amber-900 hover:bg-amber-100"
                      >
                        Dismiss Flag
                      </Button>
                      <Button
                        variant="secondary"
                        className="flex-1 bg-amber-600 hover:bg-amber-700 text-white text-sm border-transparent"
                      >
                        Require Proof
                      </Button>
                    </div>
        ...
        <div className="p-5 border-t border-slate-200 bg-white shrink-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              variant="outline"
              className="h-11 text-slate-700 border-slate-300 hover:bg-slate-50 font-semibold shadow-sm"
            >
              Escalate to Human
            </Button>
