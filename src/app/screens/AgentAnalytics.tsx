...
export function AgentAnalytics() {
  const data = [
    { name: "Mon", sessions: 45, success: 92, risk: 12 },
    { name: "Tue", sessions: 52, success: 94, risk: 8 },
    { name: "Wed", sessions: 38, success: 90, risk: 15 },
    { name: "Thu", sessions: 65, success: 95, risk: 6 },
    { name: "Fri", sessions: 48, success: 91, risk: 10 },
    { name: "Sat", sessions: 25, success: 88, risk: 18 },
    { name: "Sun", sessions: 20, success: 85, risk: 20 },
  ];
